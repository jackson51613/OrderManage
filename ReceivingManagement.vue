<template>
  <div style="text-align: left">
    <div style="padding: 10px">
      ...
      <span>商品名: 
        <el-input  style="font-size: 12px; width: 220px">
        </el-input>
      </span><br><br>
    ...
    <div style="margin-top: 10px">
      <el-table :data="items" border stripe :header-cell-style="{ background: '#eee' }"
        ...
        <el-table-column prop="orderNumber" label="種別" min-width="10%" header-align="center">
        </el-table-column>
        <el-table-column prop="orderDate" label="商品名" min-width="10%" align="center" header-align="center">
        </el-table-column>
        <el-table-column prop="orderQuantity" label="商品情報" min-width="10%" align="right" header-align="center">
        </el-table-column>
        <el-table-column prop="totalPrice" label="仕入価格" min-width="10%" align="right" header-align="right">
        </el-table-column>
        <el-table-column prop="orderStatus" label="入庫数量" min-width="10%" align="center">
